...
namespace ThreeTilesLevelManager
{
  public class LevelManager : MonoBehaviour
  {
    ...
    {
      SoundManager.Instance.PlaySound(SoundName.SELECTEDTILE,0.25f);
    ...
    public void HandleThreeMatching(Tile tile)
    {
      ...
      if (countSameId >= 3)
      {
        SoundManager.Instance.PlaySound(SoundName.MATCHINGTILE,0.25f);
    ...
    {
      SoundManager.Instance.PlaySound(SoundName.BUTTONCLICK,0.25f);
      tileQueueContains = 7;
    ...
    {
      SoundManager.Instance.PlaySound(SoundName.BUTTONCLICK,0.3f);
